...
func (tc *TenantCreate) SetParentID(i int32) *TenantCreate {
	tc.mutation.SetParentID(i)
	return tc
}

// SetModel sets the "model" field.
func (tc *TenantCreate) SetModel(s string) *TenantCreate {
	tc.mutation.SetModel(s)
	return tc
}

// SetIsApplication sets the "is_application" field.
func (tc *TenantCreate) SetIsApplication(b bool) *TenantCreate {
	tc.mutation.SetIsApplication(b)
	return tc
}

// SetAccessKey sets the "access_key" field.
func (tc *TenantCreate) SetAccessKey(s string) *TenantCreate {
	tc.mutation.SetAccessKey(s)
	return tc
}
...
func (tc *TenantCreate) SetDashboard(s string) *TenantCreate {
	tc.mutation.SetDashboard(s)
	return tc
}
...
func (tc *TenantCreate) check() error {
	...
	if _, ok := tc.mutation.Model(); !ok {
		return &ValidationError{Name: "model", err: errors.New(`ent: missing required field "Tenant.model"`)}
	}
	if _, ok := tc.mutation.IsApplication(); !ok {
		return &ValidationError{Name: "is_application", err: errors.New(`ent: missing required field "Tenant.is_application"`)}
	}
	if _, ok := tc.mutation.AccessKey(); !ok {
		return &ValidationError{Name: "access_key", err: errors.New(`ent: missing required field "Tenant.access_key"`)}
	}
...
func (tc *TenantCreate) createSpec() (*Tenant, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(tenant.Table, sqlgraph.NewFieldSpec(tenant.FieldID, field.TypeInt32))
	)
	...
	if value, ok := tc.mutation.IsApplication(); ok {
		_spec.SetField(tenant.FieldIsApplication, field.TypeBool, value)
		_node.IsApplication = value
	}
	if value, ok := tc.mutation.AccessKey(); ok {
