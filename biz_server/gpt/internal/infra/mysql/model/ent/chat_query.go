...
func (cq *ChatQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (cq *ChatQuery) FirstIDX(ctx context.Context) int32 {
...
func (cq *ChatQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (cq *ChatQuery) OnlyIDX(ctx context.Context) int32 {
...
func (cq *ChatQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (cq *ChatQuery) IDsX(ctx context.Context) []int32 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *ChatQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(chat.Table, chat.Columns, sqlgraph.NewFieldSpec(chat.FieldID, field.TypeInt32))
	_spec.From = cq.sql
