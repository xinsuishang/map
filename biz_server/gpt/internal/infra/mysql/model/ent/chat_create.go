...
func (cc *ChatCreate) SetModelID(i int32) *ChatCreate {
	cc.mutation.SetModelID(i)
	return cc
}

// SetSessionID sets the "session_id" field.
func (cc *ChatCreate) SetSessionID(s string) *ChatCreate {
...
func (cc *ChatCreate) SetID(i int32) *ChatCreate {
	cc.mutation.SetID(i)
	return cc
}
...
func (cc *ChatCreate) check() error {
	...
	if _, ok := cc.mutation.ModelID(); !ok {
		return &ValidationError{Name: "model_id", err: errors.New(`ent: missing required field "Chat.model_id"`)}
	}
	...
	if v, ok := cc.mutation.ID(); ok {
		if err := chat.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "Chat.id": %w`, err)}
		}
	}
	return nil
}
...
func (cc *ChatCreate) createSpec() (*Chat, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(chat.Table, sqlgraph.NewFieldSpec(chat.FieldID, field.TypeInt32))
	)
