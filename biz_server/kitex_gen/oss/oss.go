...
type WeightUploadRequest struct {
	...
	ForceUpload bool    `thrift:"forceUpload,4" frugal:"4,default,bool" json:"forceUpload"`
	DateTime    string  `thrift:"dateTime,5" frugal:"5,default,string" json:"dateTime"`
}
...
func (p *WeightUploadRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("forceUpload", thrift.BOOL, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *WeightUploadRequest) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("dateTime", thrift.STRING, 5); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *WeightUploadRequest) DeepEqual(ano *WeightUploadRequest) bool {
	...
	if !p.Field4DeepEqual(ano.ForceUpload) {
		return false
	}
	if !p.Field5DeepEqual(ano.DateTime) {
		return false
	}
	return true
}
...
func (p *WeightUploadRequest) Field4DeepEqual(src bool) bool {
...
func (p *WeightUploadRequest) Field5DeepEqual(src string) bool {
