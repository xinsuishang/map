...
// The DomainMappingFunc type is an adapter to allow the use of ordinary
// function as DomainMapping mutator.
type DomainMappingFunc func(context.Context, *ent.DomainMappingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DomainMappingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DomainMappingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DomainMappingMutation", m)
}
